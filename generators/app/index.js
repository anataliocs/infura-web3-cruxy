...
module.exports = class extends Generator {
  prompting() {
    ...
    this.log(
      yosay(
        `Welcome to the Infura ${chalk.red('Web3 dApp')} Witch/Wizard!`
      )
    );

    this.log(`${chalk.rgb(255,88,51).bold(

         '^!~~^^:J@!:^^~!!:      !??J??7.  !J^   ^?   :J??????. ~7    ~7  .?????7:     .J?\n' +
         '     .:Y@?:.           ::^&?::   5#G7  7#   !&~^^^^^  JB    ?B  :&!:::7#:    PPB?\n' +
         '!Y5PPP5G@P5PPP5J~        .#!     55.P5 7#   ~&JJJJJ^  JG    ?B  :#J!77JP.   J#^!&~\n' +
         '7Y7^.  7@^  :~7Y~        .&!     5P  JPY#   !&.       !#^  .PP  :&7^!BP.   7#?77J#^\n' +
         '       ?@~             !JJPY??.  ??   !GY   ^5.        !YJJY?.  .5:  .Y?  .5~    ?J\n' +
         '7BBGPPPG#PPPPGBB^\n'
      )}
    `);
